...
jsPsych.plugins["wtw-standard-discrete-block"] = (function(){

  var plugin = {};

  plugin.info = {
    name: "wtw-standard-discrete-block",
    ...
    */
    ...
    if (cb == "discrete"){
      ...
      `<div class="container" id="jspsych-wtw-content">
          ...
          <div id="jspsych-wtw-progress"></div>
          <div id="jspsych-wtw-bar"></div>
          <div id = 'jspsych-wtw-bar-info1'></div>
          <div id = 'jspsych-wtw-bar-info2'></div>
          <div id = 'jspsych-wtw-bar-info3'></div>
          <div id = 'jspsych-wtw-bar-info4'></div>
          <div id = 'jspsych-wtw-bar-info5'></div>
          <div id = 'jspsych-wtw-bar-info6'></div>
          <div id = 'jspsych-wtw-bar-info7'></div>
          <div id = 'jspsych-wtw-bar-info8'></div>
          <div id = 'jspsych-wtw-bar-info9'></div>
         <div id = 'jspsych-wtw-bar-info10'></div>
         <div id="jspsych-wtw-empty-progress"></div>
