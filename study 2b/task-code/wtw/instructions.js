...
jsPsych.plugins.instructions = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    instructions_1a_text = '<p style="color: white; font-size: 30px; line-height: 2" id="instruction">You will see a token on the screen. Tokens can be sold for ' + matruation_value + " &#162 </p>" +
            '<p style="color: white; font-size: 30px; line-height: 2">Each token is worth ' + initial_value + " &#162 at first.</p>" +
    ...
    instructions_1b_text  = '<p style="color: white; font-size: 30px; line-height: 2">Now try a practice round.</p>' +
    ...
    instructions_2_text = '<p style="color: white; font-size: 30px; line-height: 2"> Good. Let' + "&#39 s do it again.</p>" +
    ...
    instructions_5_text = '<p style="color: white; font-size: 30px; line-height: 2">The task has two blocks. Each block has ' + block_time / 1000 / 60 + ' minutes.</p>' +
    ...
    '<p style="color: white; font-size: 30px; line-height: 2">Click "Next" to start the first block.</p>'

    instructions_6_text = '<p style="color: white; font-size: 30px; line-height: 2">You just completed the first block. Please take a rest.</p>' +
    ...
    passive_instructions_1a_text = '<p style="color: white; font-size: 30px; line-height: 2" id="instruction">You will see a token on the screen. Tokens can be sold for ' + matruation_value + " &#162 </p>" +
            '<p style="color: white; font-size: 30px; line-height: 2">Each token is worth ' + initial_value + " &#162 at first.</p>" +
            '<p style="color: white; font-size: 30px; line-height: 2">After some time, the token will "mature" and be worth more.</p>' 
