...
%%%% OPTIONAL: fictive feedback about the reward delivery time
feedbackColor = [170 170 250];
if ~isnan(display.fictiveRect)
    Screen('FillRect',wid,feedbackColor,display.fictiveRect);
end
